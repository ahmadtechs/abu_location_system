...
import {
  ...
  let mapRegion = {
    ...
    latitudeDelta: 0.1,
    longitudeDelta: Dimensions.get('window').width / Dimensions.get('window').width * 0.1,
  };
      ...
      <MapView
        ...
        >
            ...
            >
                ...
                <Icon type='Feather' name='chevron-right' size={20} style={{color: 'grey'}}/>
            ...
            apikey={'AIzaSyBBeqjW0c18h8N8wPtlTUNK64_xp8my62A'} 
            mode='WALKING'
         ...
         <SafeAreaView style={styles.container}>
          ...
          <View style={styles.buttomContent}>
              ...
              <Icon name="grid" size={20} type='Ionicons' style={{color: 'white'}}/>
              </View>
           <View style={styles.infoWrapper}>
              <Text style={{fontSize: 20, color: 'grey'}}>LKR-550 600</Text>
              <View style={styles.note}><Text style={{fontWeight: 'bold', color: 'grey'}}>Note: </Text>
